...
public class TestAccelerometerData {
    ...
    public TestAccelerometerData(long systemCurrentTimeMillis, long nanoTime, long elapsedRealtimeNanos, long accelerometerTimeStamp, float[] accelerometerEvent) {
